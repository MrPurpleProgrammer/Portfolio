...
var ContactButton = function (_Component) {
    _inherits(ContactButton, _Component);

    function ContactButton() {
        _classCallCheck(this, ContactButton);

        return _possibleConstructorReturn(this, (ContactButton.__proto__ || Object.getPrototypeOf(ContactButton)).apply(this, arguments));
    }

    _createClass(ContactButton, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            var btn1 = document.querySelector('#btnContactButton');
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'button',
                    { id: 'btnContactButton', className: 'headerButton' },
                    _react2.default.createElement(
                        _reactRouterDom.NavLink,
                        { to: '/About', className: 'headerButttonLink' },
                        'About Us'
                    )
                )
            );
