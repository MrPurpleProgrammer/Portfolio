...
var AccountButton = function (_Component) {
    _inherits(AccountButton, _Component);

    function AccountButton() {
        _classCallCheck(this, AccountButton);

        return _possibleConstructorReturn(this, (AccountButton.__proto__ || Object.getPrototypeOf(AccountButton)).apply(this, arguments));
    }

    _createClass(AccountButton, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            var btn1 = document.querySelector('#btnAccountButton');
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'button',
                    { id: 'btnAccountButton', className: 'headerButton' },
                    _react2.default.createElement(
                        _reactRouterDom.Link,
                        { to: '/Login', className: 'headerButttonLink' },
                        'Login'
                    )
                )
            );
